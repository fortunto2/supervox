...
### Tasks
- [ ] Task 4.1: Update CLAUDE.md with new CLI commands (`delete`, `export`, `search`), new keybindings ('d' in History, 'e' in Analysis)
- [ ] Task 4.2: Update README.md with new commands and keybindings
