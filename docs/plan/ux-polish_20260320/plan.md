...
## Phase 4: Docs & Cleanup <!-- checkpoint:a157e62 -->

### Tasks

- [x] Task 4.1: Update CLAUDE.md with new keybindings (`?` help, `h` history, `j/k` nav), new config fields (`llm_backend`, `ollama_model`), new CLI flags (`--json`, `--local`), and History mode description. <!-- sha:a157e62 -->
- [x] Task 4.2: Update README.md with new features — help overlay, call history browser, Ollama support, JSON output examples. <!-- sha:a157e62 -->
- [x] Task 4.3: Remove dead code — unused imports, orphaned files, stale exports. Run `cargo clippy --workspace -- -D warnings` and fix any warnings. <!-- sha:a157e62 -->

### Verification

- [x] CLAUDE.md reflects current project state
- [x] README.md documents all new features
